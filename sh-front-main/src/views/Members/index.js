...
export function MembersView() {
  useEffect(() => {
    document.title = "Segundo Hogar - Nuestro equipo";
  }, []);
  return (
    <div>
      ...
      <Stack direction={["column", "row"]} spacing="24px">
        ...
        >
          ...
          >
            ...
            <Text align={"center"} justify={"center"} mt="2" color="gray.500">
              Team Lead, Analyst and Tester
            </Text>
          </Box>
